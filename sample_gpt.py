...
eval_interval = 100
learning_rate = 1e-3
device = 'cuda' if torch.cuda.is_available() else 'cpu'  # for apple silicon 
eval_iters = 200
n_embd = 64
n_head = 4
n_layer = 4
...
# 自動要約AIを作成するためのデータ読み込み (評価・開発用データ)
...
class BigramLanguageModel(nn.Module):
    ...
    def forward(self, idx, targets=None):
        B, T = idx.shape # idx: batch, token_length
